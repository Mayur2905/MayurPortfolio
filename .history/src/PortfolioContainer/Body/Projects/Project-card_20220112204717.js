...
We can also search about actors and can see their country and alive or dead.
            ...
            <img src={require('../../../assets/Home/Box-Office.JPG').default} alt='No internet'/>
        </div>
        <div className='project-card'>
            <div className="project-info">
            ...
            <img src={require('../../../assets/Home/Capture.JPG').default} alt='No internet'/>
        </div>
        <div className='project-card'>
            <div className="project-info">
            ...
            <img src={require('../../../assets/Home/Mobile_Shoppee.png').default} alt='No internet'/>
        </div>
    </div>
    )
}
